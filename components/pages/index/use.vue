...
import Diasporas from '~/assets/images/use/Diasporas.png'
import Governments from '~/assets/images/use/Governments.png'
  ...
  >
    <div class="flex flex-col gap-2">
      ...
      <span class="text-muted-foreground text-center">
        Wherever you are and whoever you are, we equip you to thrive in a constantly evolving
        21st-century world with modular digital tools.
      </span>
    </div>
    <ui-horizontal-list
      class="w-full"
